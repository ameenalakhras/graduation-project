...
def get_full_user_path_for_thumbnail(instance):
    """return the full user path including the user id"""
    return f"{settings.DEFAULT_USER_PATH}/{instance.course.user.id}"
...
def get_thumbnail_path(instance, filename):
    random_id = generate_string_random_id()
    user_path = get_full_user_path_for_thumbnail(instance)
    return f'{user_path}/thumbnails/{random_id}/{filename}'
